...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("earthcoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No earthcoin application found.\nPlease install earthcoin Wallet.", Toast.LENGTH_LONG).show();
