...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
    ...
    public static class SendRequest {
         ...
         */
        public static SendRequest to(Address destination, BigInteger value, String txComment) {
         ...
         */
        public static SendRequest to(NetworkParameters params, ECKey destination, BigInteger value, String txComment) {
            SendRequest req = new SendRequest();
     ...
     */
    public Transaction createSend(Address address, BigInteger nanocoins, String txComment) throws InsufficientMoneyException {
        SendRequest req = SendRequest.to(address, nanocoins, txComment);
        completeTx(req);
        return req.tx;
    }
     ...
     * @throws InsufficientMoneyException if the request could not be completed due to not enough balance.
     */
    public SendResult sendCoins(TransactionBroadcaster broadcaster, Address to, BigInteger value, String txComment) throws InsufficientMoneyException {
        SendRequest request = SendRequest.to(to, value, txComment);
