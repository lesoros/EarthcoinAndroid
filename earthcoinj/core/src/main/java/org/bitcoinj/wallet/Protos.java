...
public final class Protos {
  ...
  public interface TransactionOrBuilder
    ...
    // optional string txcomment = 5;
    /**
     * <code>optional string txcomment = 5;</code>
     */
    boolean hasTxcomment();
    /**
     * <code>optional string txcomment = 5;</code>
     */
    java.lang.String getTxcomment();
    /**
     * <code>optional string txcomment = 5;</code>
     */
    com.google.protobuf.ByteString
    ...
    // repeated .wallet.TransactionInput transaction_input = 7;
    /**
     * <code>repeated .wallet.TransactionInput transaction_input = 7;</code>
     */
    ...
    // repeated .wallet.TransactionOutput transaction_output = 8;
    /**
     * <code>repeated .wallet.TransactionOutput transaction_output = 8;</code>
     */
    ...
    // repeated bytes block_hash = 9;
    /**
     * <code>repeated bytes block_hash = 9;</code>
     *
     * <pre>
    ...
    // repeated int32 block_relativity_offsets = 12;
    /**
     * <code>repeated int32 block_relativity_offsets = 12;</code>
     */
    ...
    // optional .wallet.TransactionConfidence confidence = 10;
    /**
     * <code>optional .wallet.TransactionConfidence confidence = 10;</code>
     *
     * <pre>
    ...
    // optional .wallet.Transaction.Purpose purpose = 11 [default = UNKNOWN];
    /**
     * <code>optional .wallet.Transaction.Purpose purpose = 11 [default = UNKNOWN];</code>
     */
    boolean hasPurpose();
    /**
     * <code>optional .wallet.Transaction.Purpose purpose = 11 [default = UNKNOWN];</code>
  ...
  public static final class Transaction extends
    ...
    // optional string txcomment = 5;
    public static final int TXCOMMENT_FIELD_NUMBER = 5;
    private java.lang.Object txcomment_;
    /**
     * <code>optional string txcomment = 5;</code>
     */
    public boolean hasTxcomment() {
      return ((bitField0_ & 0x00000010) == 0x00000010);
    }
    /**
     * <code>optional string txcomment = 5;</code>
     */
    public java.lang.String getTxcomment() {
      java.lang.Object ref = txcomment_;
      if (ref instanceof java.lang.String) {
        return (java.lang.String) ref;
      } else {
        com.google.protobuf.ByteString bs = 
    ...
    // repeated .wallet.TransactionInput transaction_input = 7;
    public static final int TRANSACTION_INPUT_FIELD_NUMBER = 7;
    ...
    // repeated .wallet.TransactionOutput transaction_output = 8;
    public static final int TRANSACTION_OUTPUT_FIELD_NUMBER = 8;
    ...
    // repeated int32 block_relativity_offsets = 12;
    public static final int BLOCK_RELATIVITY_OFFSETS_FIELD_NUMBER = 12;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000010) == 0x00000010)) {
        output.writeBytes(5, getTxcommentBytes());
      }
      if (((bitField0_ & 0x00000020) == 0x00000020)) {
        output.writeInt64(6, updatedAt_);
      }
      for (int i = 0; i < transactionInput_.size(); i++) {
        output.writeMessage(7, transactionInput_.get(i));
      }
      for (int i = 0; i < transactionOutput_.size(); i++) {
        output.writeMessage(8, transactionOutput_.get(i));
      }
      for (int i = 0; i < blockHash_.size(); i++) {
        output.writeBytes(9, blockHash_.get(i));
      }
      if (((bitField0_ & 0x00000040) == 0x00000040)) {
      ...
      for (int i = 0; i < blockRelativityOffsets_.size(); i++) {
        output.writeInt32(12, blockRelativityOffsets_.get(i));
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000010) == 0x00000010)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(5, getTxcommentBytes());
      }
      if (((bitField0_ & 0x00000020) == 0x00000020)) {
        size += com.google.protobuf.CodedOutputStream
      ...
      for (int i = 0; i < transactionInput_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, transactionInput_.get(i));
      }
      for (int i = 0; i < transactionOutput_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, transactionOutput_.get(i));
      }
      {
        int dataSize = 0;
        for (int i = 0; i < blockHash_.size(); i++) {
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(org.bitcoinj.wallet.Protos.Transaction other) {
        ...
        if (other.hasTxcomment()) {
          bitField0_ |= 0x00000010;
          txcomment_ = other.txcomment_;
          onChanged();
        }
  ...
  bitField0_ |= 0x00000010;
       ...
       * <code>optional string txcomment = 5;</code>
       */
      public Builder clearTxcomment() {
        bitField0_ = (bitField0_ & ~0x00000010);
        txcomment_ = getDefaultInstance().getTxcomment();
        onChanged();
        return this;
      }
      /**
       * <code>optional string txcomment = 5;</code>
       */
      public Builder setTxcommentBytes(
          com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "K\020\001\022\017\n\013SOURCE_SELF\020\002\"\261\004\n\013Transaction\022\017\n\007" +
      "version\030\001 \002(\005\022\014\n\004hash\030\002 \002(\014\022&\n\004pool\030\003 \001(",
      "\0162\030.wallet.Transaction.Pool\022\021\n\tlock_time" +
      "\030\004 \001(\r\022\021\n\ttxcomment\030\005 \001(\t\022\022\n\nupdated_at\030" +
      "\006 \001(\003\0223\n\021transaction_input\030\007 \003(\0132\030.walle" +
      "t.TransactionInput\0225\n\022transaction_output" +
      "\030\010 \003(\0132\031.wallet.TransactionOutput\022\022\n\nblo" +
      "ck_hash\030\t \003(\014\022 \n\030block_relativity_offset" +
      "s\030\014 \003(\005\0221\n\nconfidence\030\n \001(\0132\035.wallet.Tra" +
      "nsactionConfidence\0225\n\007purpose\030\013 \001(\0162\033.wa" +
      "llet.Transaction.Purpose:\007UNKNOWN\"Y\n\004Poo" +
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_wallet_Transaction_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_wallet_Transaction_descriptor,
              new java.lang.String[] { "Version", "Hash", "Pool", "LockTime", "Txcomment", "UpdatedAt", "TransactionInput", "TransactionOutput", "BlockHash", "BlockRelativityOffsets", "Confidence", "Purpose", });
          internal_static_wallet_ScryptParameters_descriptor =
